...
class Ui_PreferencesWindow(object):
    def setupUi(self, PreferencesWindow):
        ...
        self.downloadDirectory = ClickableLabel(self.directoryWidget_2)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.downloadDirectory.sizePolicy().hasHeightForWidth())
        self.downloadDirectory.setSizePolicy(sizePolicy)
        self.downloadDirectory.setMinimumSize(QtCore.QSize(0, 40))
        self.downloadDirectory.setObjectName("downloadDirectory")
        self.horizontalLayout_3.addWidget(self.downloadDirectory)
        self.browseDownloadDirectoryButton = QtWidgets.QPushButton(self.directoryWidget_2)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.browseDownloadDirectoryButton.sizePolicy().hasHeightForWidth())
        self.browseDownloadDirectoryButton.setSizePolicy(sizePolicy)
        self.browseDownloadDirectoryButton.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        self.browseDownloadDirectoryButton.setIconSize(QtCore.QSize(24, 24))
        self.browseDownloadDirectoryButton.setFlat(False)
        self.browseDownloadDirectoryButton.setObjectName("browseDownloadDirectoryButton")
        self.horizontalLayout_3.addWidget(self.browseDownloadDirectoryButton)
        ...
        self.scrollAreaWidgetContents_4.setGeometry(QtCore.QRect(0, 0, 73, 129))
    ...
    def retranslateUi(self, PreferencesWindow):
        ...
        self.label_11.setText(_translate("PreferencesWindow", "Download Directory"))
        self.downloadDirectory.setText(_translate("PreferencesWindow", "~/MusicDragon"))
        self.browseDownloadDirectoryButton.setText(_translate("PreferencesWindow", "Browse"))
