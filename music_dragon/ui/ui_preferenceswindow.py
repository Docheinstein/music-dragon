...
class Ui_PreferencesWindow(object):
    def setupUi(self, PreferencesWindow):
        ...
        self.scrollAreaWidgetContents_3.setGeometry(QtCore.QRect(0, 0, 191, 262))
        ...
        self.scrollAreaWidgetContents_2.setGeometry(QtCore.QRect(0, 0, 383, 236))
        ...
        self.scrollAreaWidgetContents_4.setGeometry(QtCore.QRect(0, 0, 98, 113))
        ...
        self.youtubeEmail = QtWidgets.QLineEdit(parent=self.scrollAreaWidgetContents_4)
        self.youtubeEmail.setInputMethodHints(QtCore.Qt.InputMethodHint.ImhEmailCharactersOnly)
        self.youtubeEmail.setObjectName("youtubeEmail")
        self.verticalLayout_15.addWidget(self.youtubeEmail)
        self.youtubePassword = QtWidgets.QLineEdit(parent=self.scrollAreaWidgetContents_4)
        self.youtubePassword.setInputMethodHints(QtCore.Qt.InputMethodHint.ImhHiddenText|QtCore.Qt.InputMethodHint.ImhNoAutoUppercase|QtCore.Qt.InputMethodHint.ImhNoPredictiveText|QtCore.Qt.InputMethodHint.ImhSensitiveData)
        self.youtubePassword.setEchoMode(QtWidgets.QLineEdit.EchoMode.Password)
