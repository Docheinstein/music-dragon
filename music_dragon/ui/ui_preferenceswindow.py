...
class Ui_PreferencesWindow(object):
    def setupUi(self, PreferencesWindow):
        ...
        self.youtubeCookiesFromBrowserCombo.addItem("")
        self.youtubeCookiesFromBrowserCombo.addItem("")
        self.verticalLayout_20.addWidget(self.youtubeCookiesFromBrowserCombo)
        ...
        self.verticalLayout_20.addWidget(self.testYoutubeCookiesFromBrowserButton)
    ...
    def retranslateUi(self, PreferencesWindow):
        ...
        self.youtubeChallengesSolverCombo.setItemText(0, _translate("PreferencesWindow", "Deno (default)"))
