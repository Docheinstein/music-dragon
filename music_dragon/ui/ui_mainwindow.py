...
"}")
        ...
        self.verticalLayout_26 = QtWidgets.QVBoxLayout(self.albumPage)
        ...
        self.albumLinkButton.setIcon(icon4)
        ...
        self.albumDownloadAllButton.setIcon(icon5)
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap(":/images/openlink.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.albumOpenButton.setIcon(icon6)
        ...
        self.verticalLayout_26.addWidget(self.albumTracks)
        ...
        self.localAlbumTitle.setAlignment(QtCore.Qt.AlignBottom|QtCore.Qt.AlignLeading|QtCore.Qt.AlignLeft)
        ...
        self.localAlbumOpenRemoteButton.setIcon(icon6)
        ...
        self.verticalLayout_25 = QtWidgets.QVBoxLayout(self.localArtistPage)
        ...
        self.verticalLayout_24.setContentsMargins(16, -1, -1, -1)
        ...
        self.verticalLayout_24.addWidget(self.localArtistName)
        ...
        self.localArtistOpenRemoteButton.setIcon(icon6)
        ...
        self.verticalLayout_25.addWidget(self.localArtistAlbums)
        ...
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap(":/images/prev.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.prevSongButton.setIcon(icon7)
        ...
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap(":/images/play.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.playPauseButton.setIcon(icon8)
        ...
        icon9 = QtGui.QIcon()
        icon9.addPixmap(QtGui.QPixmap(":/images/next.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.nextSongButton.setIcon(icon9)
