...
"}")
        ...
        self.playBar = QtWidgets.QProgressBar(self.playContainer)
        self.playBar.setMinimumSize(QtCore.QSize(0, 8))
        self.playBar.setMaximumSize(QtCore.QSize(16777215, 8))
        self.playBar.setProperty("value", 0)
        self.playBar.setTextVisible(False)
