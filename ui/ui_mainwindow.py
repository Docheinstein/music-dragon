...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.albumCoverNextButton.setIcon(icon1)
        self.albumCoverNextButton.setFlat(True)
        self.albumCoverNextButton.setObjectName("albumCoverNextButton")
        self.gridLayout.addWidget(self.albumCoverNextButton, 0, 2, 1, 1)
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap("./res/ui/../images/download.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.albumDownloadAllButton.setIcon(icon2)
