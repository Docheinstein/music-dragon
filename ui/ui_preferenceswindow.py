...
class Ui_PreferencesWindow(object):
    def setupUi(self, PreferencesWindow):
        ...
        self.cacheSize = QtWidgets.QLabel(self.scrollAreaWidgetContents_3)
        self.cacheSize.setObjectName("cacheSize")
        self.verticalLayout_12.addWidget(self.cacheSize)
        self.cacheImagesCheck = QtWidgets.QCheckBox(self.scrollAreaWidgetContents_3)
        self.cacheImagesCheck.setObjectName("cacheImagesCheck")
        self.verticalLayout_12.addWidget(self.cacheImagesCheck)
        self.cacheRequestsBox = QtWidgets.QCheckBox(self.scrollAreaWidgetContents_3)
        self.cacheRequestsBox.setObjectName("cacheRequestsBox")
        self.verticalLayout_12.addWidget(self.cacheRequestsBox)
        self.cacheClearButton = QtWidgets.QPushButton(self.scrollAreaWidgetContents_3)
        icon1 = QtGui.QIcon()
        ...
        self.verticalLayout_12.addWidget(self.cacheClearButton)
