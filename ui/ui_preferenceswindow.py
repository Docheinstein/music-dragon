...
class Ui_PreferencesWindow(object):
    def setupUi(self, PreferencesWindow):
        ...
        self.cacheSize = QtWidgets.QLabel(self.tab_3)
        self.cacheSize.setObjectName("cacheSize")
        self.verticalLayout_11.addWidget(self.cacheSize)
        self.cacheImagesCheck = QtWidgets.QCheckBox(self.tab_3)
        self.cacheImagesCheck.setObjectName("cacheImagesCheck")
        self.verticalLayout_11.addWidget(self.cacheImagesCheck)
        self.cacheRequestsBox = QtWidgets.QCheckBox(self.tab_3)
        self.cacheRequestsBox.setObjectName("cacheRequestsBox")
        self.verticalLayout_11.addWidget(self.cacheRequestsBox)
        self.cacheClearButton = QtWidgets.QPushButton(self.tab_3)
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("./res/ui/../images/delete.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.cacheClearButton.setIcon(icon1)
        self.cacheClearButton.setIconSize(QtCore.QSize(24, 24))
        self.cacheClearButton.setObjectName("cacheClearButton")
        self.verticalLayout_11.addWidget(self.cacheClearButton)
    ...
    def retranslateUi(self, PreferencesWindow):
        ...
        self.cacheSize.setText(_translate("PreferencesWindow", "Cache size: 0MB"))
