...
from PyQt5.QtCore import Qt, QSize, QRect, QPoint, QModelIndex, QAbstractListModel, QVariant, QAbstractItemModel, \
    QEvent, pyqtSignal, QObject
from PyQt5.QtGui import QPainter, QIcon, QMouseEvent
...
from repository import get_artist
from ui.clickablelabel import ClickableLabel
from utils import make_icon_from_data, make_pixmap_from_data
...
class LocalArtistsItemDelegate(QStyledItemDelegate):
    ...
    def paint(self, painter: QPainter, option: 'QStyleOptionViewItem', index: QModelIndex) -> None:
        ...
        # # Icon
        icon = make_icon_from_data(image, default=ui.resources.PERSON_PLACEHOLDER_ICON)
...
class LocalArtistsModel(QAbstractListModel):
    ...
    def reload(self):
        ...
        for mp3 in localsongs.mp3s:
            if mp3.artist not in mp3s_by_artists or not mp3s_by_artists[mp3.artist].image:
